...
eleventyNavigation:
  title: Prerequisites
  key: getting-started-android-google-prerequisites
...
<p class="next-article"><a class="mi-button mi-button--outline" href="{{ site.url }}/content/getting-started/android/google-maps/new-project/">Next up: Create a new project</a>
