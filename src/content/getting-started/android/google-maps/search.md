...
eleventyNavigation:
  title: Search
  key: getting-started-android-google-search
...
<p class="next-article"><a class="mi-button mi-button--outline" href="{{ site.url }}/content/getting-started/android/google-maps/directions/">Next up: Directions</a></p>
