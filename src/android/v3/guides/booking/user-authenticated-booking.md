...
It is highly recommended to first read the [guide on Booking](../booking/index.md) to get an an understanding of how booking functions in the MapsIndoors SDK.
