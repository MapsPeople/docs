...
eleventyNavigation:
  ...
  key: android-v4-getting-started-project
...
You can also follow the steps below to start your app from scratch or to enhance the Basic Examples, more features will be explained in the [guides]({{ site.url }}/android/v4/guides/).
...
<p class="next-article"><a class="mi-button mi-button--outline" href="{{ site.url }}/android/v4/getting-started/map/">Next up: Show a map</a></p>
